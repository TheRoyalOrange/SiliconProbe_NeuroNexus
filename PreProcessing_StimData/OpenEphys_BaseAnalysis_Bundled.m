...
% 
% INPUTS:
%   data - Some or all OpenEphys recordings from an animal in .Rhythm Data format. (a recording is
...
%   
%   stim_all - PROVIDED BY USER. cell of strings providing name of the stimulus in each recording. 
% 
%   other assorted parameters set by the user
% 
% OUTPUTS (one per recording):
